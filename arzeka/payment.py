...
class BasePayment(object):
    ...
    def post(self, url, **kwargs) -> requests.Response:
        ...
        response = requests.post(url, headers=headers_, json=kwargs, verify=False)
    ...
    def get(self, url, **kwargs) -> requests.Response:
        ...
        response = requests.get(url, headers=headers_, params=kwargs, verify=False)
        return response
...
class ArzekaPayment(BasePayment):
    ...
    def initiate_payment(self, **kwargs):
        ...
        return self.get(self.url + "validorder", **kwargs)
